...
- 不准用破折号（——），需要解释另起一句。
- 不写"第一个第二个第三个""首先其次最后"。
- 删掉"随着时代发展""越来越多人意识到""这一趋势值得关注""这说明""因此"这类空话和过度总结句。每节末尾自然收住。
- 缩小叙事半径："对部分企业而言"不写成"中国制造迎来历史机遇"。
- 段落长短交替，不要每段150-200字均匀排列。
...
## 必须做的事：
1. 去重：同一公司背景、产品参数、市场数据，只在最相关章节出现一次，后文用"如前所述"引用。
2. 挂钩：每章开头接上一章，每章结尾引出下一章。
3. 观点前置：每个小节开头放判断句，数据案例在后。
4. 收束：第七章结尾汇聚前六章线索。
...
- 不用破折号（——），需要解释另起一句
- 不用"首先其次然后最后"
- 删掉"随着时代发展""越来越多人意识到""这一趋势值得关注"这类空话
- 删掉"这说明""因此""由此可见"等过度总结句
- 缩小叙事半径："对部分企业而言"不要写成"中国制造迎来历史机遇"
- 段落长短交替，不要每段150-200字均匀排列
